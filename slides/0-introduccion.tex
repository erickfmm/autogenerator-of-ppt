...
\begin{exampleblock}{✨ Ejemplo}
¿Qué tan posible es que llueva hoy? ¿50 por ciento? ¿80 por ciento?
\end{exampleblock}
...
\begin{itemize}
  \item Probabilidad (tu lado mago): ¿Qué crees que debería salir? Teóricamente, es 50 por ciento y 50 por ciento.
\end{itemize}
...
\begin{itemize}
  \item Imposible (0 por ciento): Que un perro maúlle.
\end{itemize}

\begin{itemize}
  \item Poco probable (25 por ciento): Ganar una rifa con muchos números.
\end{itemize}

\begin{itemize}
  \item Puede ser (50 por ciento): Que salga 'sello' al lanzar una moneda.
\end{itemize}

\begin{itemize}
  \item Muy probable (75 por ciento): Que un helado se derrita en el sol.
\end{itemize}

\begin{itemize}
  \item Seguro (100 por ciento): Que después del 1 venga el 2.
\end{itemize}
