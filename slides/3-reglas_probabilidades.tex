...
\begin{tikzpicture}
  \begin{axis}[
    ...
    bar width=15pt,
    ylabel={Porcentaje (%)},
    xlabel={Nivel de probabilidad},
    symbolic x coords={Imposible,Poco-probable,Igual,Muy-probable,Seguro},
    xtick=data,
...
\begin{tikzpicture}
  \pie[
    ...
    50/Pares (2,4,6),    50/Impares (1,3,5)  }
\end{tikzpicture}
\end{center}
\end{frame}
...
\begin{tikzpicture}
  \pie[
    ...
    44/Verdes,    33/Amarillas,    22/Negras  }
\end{tikzpicture}
\end{center}
\end{frame}
