...
\begin{itemize}
  \item También se usa en porcentajes (0 por ciento a 100 por ciento).
\end{itemize}
...
\begin{itemize}
  \item 0 o 0 por ciento: Imposible (nunca, nunca pasa).
\end{itemize}

\begin{itemize}
  \item 0.25 o 25 por ciento: Poco probable (raro que pase).
\end{itemize}

\begin{itemize}
  \item 0.5 o 50 por ciento: Chance 50/50 (puede ser que sí, puede ser que no).
\end{itemize}

\begin{itemize}
  \item 0.75 o 75 por ciento: Muy probable (casi siempre pasa).
\end{itemize}

\begin{itemize}
  \item 1 o 100 por ciento: Seguro (siempre, siempre pasa).
\end{itemize}
...
\begin{itemize}
  \item Imposible: 0 por ciento (Que un pez vuele )
\end{itemize}

\begin{itemize}
  \item Poco probable: 25 por ciento (Sacar un 6 en un dado )
\end{itemize}

\begin{itemize}
  \item Igual de probable: 50 por ciento (Que salga 'cara' en una moneda )
\end{itemize}

\begin{itemize}
  \item Muy probable: 75 por ciento (Que mañana salga el sol )
\end{itemize}

\begin{itemize}
  \item Seguro: 100 por ciento (Que después del Lunes venga el Martes)
\end{itemize}
...
\colorbox{colorFondo}{%
  \parbox{0.9\textwidth}{%
    \begin{align*}
    Probabilidad = 3 / 6 = 1/2 = 50 por ciento
    \end{align*}
  }%
}
\end{center}
...
\begin{alertblock}{💡 Nota importante}
¡Tienes un 50 por ciento de probabilidad! ¡La mitad de las veces ganarás!
\end{alertblock}
...
\begin{itemize}
  \item • Pares: 2, 4, 6 (3 números = 50 por ciento de chance)
\end{itemize}

\begin{itemize}
  \item • Impares: 1, 3, 5 (3 números = 50 por ciento de chance)
\end{itemize}
...
\colorbox{colorFondo}{%
  \parbox{0.9\textwidth}{%
    \begin{align*}
    Probabilidad de As = 4 / 40 = 1/10 = 10 por ciento
    \end{align*}
  }%
}
\end{center}
...
\begin{itemize}
  \item ¡Tienes un 10 por ciento de probabilidad de sacar un As!
\end{itemize}
...
\begin{alertblock}{💡 Nota importante}
¡Si hay 30 por ciento de chance de lluvia, hay 70 por ciento de que NO llueva!
\end{alertblock}
...
\begin{itemize}
  \item Si hay 30 por ciento de probabilidad de que llueva:
\end{itemize}

\begin{itemize}
  \item • Lluvia: 30 por ciento
\end{itemize}

\begin{itemize}
  \item • No Lluvia: 70 por ciento (el resto)
\end{itemize}

\begin{itemize}
  \item Total: 30 por ciento + 70 por ciento = 100 por ciento
\end{itemize}

\begin{alertblock}{💡 Nota importante}
¡Lo que pasa y lo que no pasa siempre suman el 100 por ciento!
\end{alertblock}
...
\colorbox{colorFondo}{%
  \parbox{0.9\textwidth}{%
    \begin{align*}
    P(As o Rey) = 4/40 + 4/40 = 8/40 = 20 por ciento
    \end{align*}
  }%
}
\end{center}
...
\colorbox{colorFondo}{%
  \parbox{0.9\textwidth}{%
    \begin{align*}
    P(Roja y Roja) = (5/8) x (4/7) = 20/56 ≈ 36 por ciento
    \end{align*}
  }%
}
\end{center}
...
\begin{alertblock}{💡 Nota importante}
¡Solo un 12.5 por ciento de probabilidad! No es tan fácil como parece. 
\end{alertblock}
...
\begin{itemize}
  \item b) Roja O Azul... ¡son las únicas que hay! Es 100 por ciento seguro que sacarás una de esas.
\end{itemize}
...
\begin{itemize}
  \item • Rojas: 5 de 8 = 62.5 por ciento de la bolsa.
\end{itemize}

\begin{itemize}
  \item • Azules: 3 de 8 = 37.5 por ciento de la bolsa.
\end{itemize}

\begin{itemize}
  \item Total: 62.5 por ciento + 37.5 por ciento = 100 por ciento
\end{itemize}
...
\colorbox{colorFondo}{%
  \parbox{0.9\textwidth}{%
    \begin{align*}
    c) P(Roja y luego Roja) = (5/8) x (4/7) = 20/56 ≈ 35.7 por ciento
    \end{align*}
  }%
}
\end{center}
