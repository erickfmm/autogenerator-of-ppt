...
\begin{itemize}
  \item ¿Qué altura tiene la persona que es más alta que el 75% del grupo?
\end{itemize}
...
\begin{itemize}
  \item La mitad (50%) de los datos son más pequeños que ella.
\end{itemize}

\begin{itemize}
  \item La otra mitad (50%) son más grandes.
\end{itemize}
...
\begin{alertblock}{💡 Nota importante}
¡Como cortar una pizza en 4 trozos!  Cada trozo es un 25%.
\end{alertblock}

\begin{itemize}
  \item Q1 (Cuartil 1): El 25% de los datos es menor que este valor.
\end{itemize}

\begin{itemize}
  \item Q2 (Cuartil 2): ¡Es la Mediana! El 50% de los datos es menor.
\end{itemize}

\begin{itemize}
  \item Q3 (Cuartil 3): El 75% de los datos es menor que este valor.
\end{itemize}
...
\begin{itemize}
  \item Q1: Supera al 25% de los datos.
\end{itemize}

\begin{itemize}
  \item Q2 (Mediana): Supera al 50% de los datos.
\end{itemize}

\begin{itemize}
  \item Q3: Supera al 75% de los datos.
\end{itemize}
...
\begin{exampleblock}{✨ Ejemplo}
Si el Q3 de salarios es S/3000, significa que el 75% de la gente gana menos que eso.
\end{exampleblock}
...
\begin{itemize}
  \item  El 25% de los datos son 5 o menos.
\end{itemize}

\begin{itemize}
  \item  El 50% de los datos son 10 o menos.
\end{itemize}

\begin{itemize}
  \item  El 75% de los datos son 15 o menos.
\end{itemize}
...
\begin{itemize}
  \item El Percentil 80 (P₈₀) significa que el 80% de los datos son menores.
\end{itemize}

\begin{exampleblock}{✨ Ejemplo}
Si estás en el P₉₀ en una prueba, ¡felicidades! Superaste al 90% de los estudiantes. 
\end{exampleblock}
...
\begin{itemize}
  \item  ¡Tu nota de 85 es excelente! Superaste al 90% de la clase.
\end{itemize}

\begin{itemize}
  \item  Solo el 10% sacó una nota más alta que 80.
\end{itemize}

\begin{alertblock}{💡 Nota importante}
¡Estás en el Top 10% del grupo! 
\end{alertblock}
...
\begin{itemize}
  \item  La Caja: va desde Q1 hasta Q3. ¡Contiene el 50% central de los datos!
\end{itemize}
...
\begin{itemize}
  \item  El 50% central de los trabajadores gana entre S/1650 y S/3250.
\end{itemize}
...
\begin{itemize}
  \item  El 25% gana menos de S/1650 (los más nuevos quizás).
\end{itemize}

\begin{itemize}
  \item  El 25% gana más de S/3250 (los de más experiencia).
\end{itemize}
